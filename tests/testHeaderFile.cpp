...
namespace Tests
{
	...
	public:
		...
		{
			auto result = HeaderFile::getLetterIndexFromFName("abc.h_0");
			Assert::AreEqual(0, result);
		}
		TEST_METHOD(testgetLetterIndexFromFName1)
		{
			auto result = HeaderFile::getLetterIndexFromFName("abc.h_A");
			Assert::AreEqual(10, result);
		}
		TEST_METHOD(testgetLetterIndexFromFName2)
		{
			auto result = HeaderFile::getLetterIndexFromFName("abc.h_2");
