...
public:
	...
	static void writeIntToCharBufffer(uint8_t* input, const unsigned int value, const unsigned int offset);
	static void writeIntToCharBufffer(std::vector<uint8_t>& input, const unsigned int value, const unsigned int offset);
