...
void Image::loadFromFile()
{
	...
	pixel_array_buffer = Image::readBytesFromFile(this->path, pixel_array_buffer, this->file_size - this->HEADER_SIZE, this->pixel_array_offset);
...
void Image::generateHeader(char *input)
{
	input[0] = 'B';
	input[1] = 'M';
